...
const makeMiddleEarth = () => {
  ...
  const sectionTag = $(`<section id="middle-earth"></section>`);
  ...
  for (let i = 0; i < lands.length; i++) {
    const newLand = $(`<article id="${lands[i]}"><h1>${lands[i]}</h1></article>`)
...
const makeBaddies = () => {
  ...
  for (let i = 0; i < baddies.length; i++) {
    const bad = $(`<li class=baddy>${baddies[i]}</li>`);
    $(`#Mordor ul`).append(bad);
  }
};
...
const makeBuddies = () => {
  ...
  $('#Mordor').append('<aside><ul></ul></aside>');

  for (let i = 0; i < buddies.length; i++) {
    const bud = $(`<li class="buddy">${buddies[i]}</li>`)
    $('#Mordor aside ul').append(bud);
...
const leaveTheShire = () => {
  ...
  const moveFromShire = $('#The-Shire').children('ul').remove();

  $('#Rivendell').append(moveFromShire);
};
...
const forgeTheFellowShip = () => {
  ...
  const hobbits = $('.hobbit').parent();
  const buds = $('.buddy').parent();
  $('#the-fellowship').append(hobbits, buds);
};
...
const weWantsIt = () => {
  ...
  const goliy = $('<div id="gollum"></div>');
  $('#Mordor').append(goliy);
  ring = $('#the-ring').remove();
  $('#gollum').append(ring);
  $('#mount-doom').append($('#gollum').remove());
};
...
const thereAndBackAgain = () => {
  ...
  $('#gollum').remove();
  $('.baddy').remove();
  $('#The-Shire').append($('.hobbit').remove());
};
